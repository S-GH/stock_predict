...
s_x_data = s_x_data.reshape(s_x_data.shape[0],25)
k_x_data = k_x_data.reshape(k_x_data.shape[0],25)
...
s_x_data = s_x_data.reshape(s_x_data.shape[0],5,5)
k_x_data = k_x_data.reshape(k_x_data.shape[0],5,5)
...
s_x_prd = s_x_data[-1]
print(s_x_prd.shape)
s_x_prd = s_x_prd.reshape(1,5,5)
k_x_prd = k_x_data[-1]
print(k_x_prd.shape)
k_x_prd = k_x_prd.reshape(1,5,5)
